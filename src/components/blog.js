    ...
    toggleCategories() {
        ...
        <CardMenu style={{color: '#fff'}}>
            ...
            {/*Blog 2*/}
    <Card shadow={5} style={{minWidth: '800px', margin: 'auto', marginTop: '30px', marginBottom: '30px'}}>
    ...
    {/*Blog 3*/}
    <Card shadow={5} style={{width: '800px', margin: 'auto', marginTop: '30px', marginBottom: '30px'}}>
        <CardTitle style={{color: '#fff', height: '300px', background: 'url(https://www.motosha.com/wp-content/uploads/sri-lanka-flag-1024x569.jpg) center / cover'}}>SRI LANKA</CardTitle>
        <CardText>
